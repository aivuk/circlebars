...
(function() {
  var chartHeight, circleDistance, circleRadius, eixos, eixosColor, fcLabels, filterColumns, metas, numbers,
  ...
  d3.csv("/data/metas.csv", function(d) {
    var chart, eixosSize, f, filterFunc, filtersDiv, ftag_id, groups, i, maxHeight, ms, o, _fn, _fn1, _i, _j, _len, _len1, _results;
